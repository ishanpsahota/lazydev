<template>
    <div class="row suggestions-pill-container mx-0 px-3 pt-3">
        <h5 class="px-1" v-if="keywords"> {{title}} </h5>
        <div class="col-12 py-2 suggestions-pill-wrapper px-0">
            <div class="badge badge-suggestions badge-pill badge-dark m-1 " v-for="(suggestion, i) in keywords" :key="i">            
